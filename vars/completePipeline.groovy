                ...
                stages('Release Deployment Flow') {
                    ...
                    stage('Approval to UAT') {
                        ...
                        steps {
                            ...
                            script {
                                def approver = input id: 'Deploy', message: 'Deploy to UAT?', submitter: 'anupam,anand,sutirtha,pradeep,mohan,prashant_verma', submitterParameter: 'deploy_approver'
                    ...
                    stage('Approval to PROD') {
                        ...
                        steps {
                            ...
                            script {
                                def approver = input id: 'Deploy', message: 'Deploy to PROD?', submitter: 'anupam,anand,sutirtha,pradeep,mohan,prashant_verma', submitterParameter: 'deploy_approver'
                                echo "This deployment was approved by ${approver}"
                            }
                        }
                    }
